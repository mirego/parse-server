...
var PARSE_FETCH_LIMIT_SIZE = 1000;
...
var PushController = exports.PushController = function (_AdaptableController) {
  ...
  _createClass(PushController, [{
    ...
    value: function sendPush() {
      ...
      var pushStatus = (0, _StatusHandler.pushStatusHandler)(body, config);
      return Promise.resolve().then(function () {
        ...
        return _this2.sendPushByBatch(config, auth, where, restOptions, pushStatus, body);
      });
    }
  }, {
    key: 'sendPushByBatch',
    value: function sendPushByBatch(config, auth, where, restOptions, pushStatus, body) {
      var _this3 = this;

      return _rest2.default.find(config, auth, '_Installation', where, restOptions).then(function (response) {
        ...
        Promise.resolve().then(function () {
          ...
          return _this3.sendToAdapter(body, response.results, pushStatus, config);
          ...
          if (shouldContinue) {
            ...
            return _this3.sendPushByBatch(config, auth, where, restOptions, pushStatus, body);
          }
          return Promise.resolve();
        });
      });
      ...
      if (body.data && body.data.badge && typeof body.data.badge == 'string' && body.data.badge.toLowerCase() == "increment") {
        var _ret2 = function () {
          ...
          var promises = Object.keys(badgeInstallationsMap).map(function (badge) {
            ...
            return _this4.adapter.send(payload, badgeInstallationsMap[badge], pushStatus.objectId);
          });
          return {
