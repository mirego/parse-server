...
var PARSE_FETCH_LIMIT_SIZE = 10000;
  ...
  _createClass(PushController, [{
    ...
    value: function sendPush() {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this2.getInstallations(config, auth, where, restOptions, []);
    ...
    value: function getInstallations(config, auth, where, restOptions, results) {
      var _this3 = this;
      ...
      return _rest2.default.find(config, auth, '_Installation', where, restOptions).then(function (response) {
        ...
        if (response.results.length === PARSE_FETCH_LIMIT_SIZE) {
          ...
          return _this3.getInstallations(config, auth, where, restOptions, results);
        }
